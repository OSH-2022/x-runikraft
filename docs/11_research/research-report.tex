...
\section{项目简介}
本项目参考 Unikraft 的设计，用 Rust 语言实现模块化的 unikernel
...
我们小组详细调研了ClickOS、MirageOS、IncludeOS、Rusty-Hermit、Rumprun
和Unikraft六个目前的unikernel项目。
