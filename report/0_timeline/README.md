...
开始常态化小组讨论，主要在中校区5号楼13楼自习室与图书馆研讨室进行。

lab4在郭耸霄、陈建绿、蓝俊玮、张子辰的合作下基本完成。
...
郭耸霄、蓝俊玮、张子辰尝试编译安装ceph，因所需计算机的代价过大而暂时搁置。
